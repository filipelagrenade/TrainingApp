            ...
            <div className="grid gap-3">
              {searchQuery.isLoading ? (
                ...
                searchResults.map((user) => (
                  <div key={user.id} className="flex items-center justify-between rounded-2xl border border-border/70 bg-background/70 p-4">
                    <div>
          ...
          <CardContent className="space-y-3">
            {followingQuery.isLoading ? (
              ...
              followingQuery.data.map((user) => (
                <div key={user.id} className="flex items-center justify-between rounded-2xl border border-border/70 p-3">
                  <div>
          ...
          <CardContent className="space-y-3">
            {leaderboardQuery.isLoading ? (
              ...
              leaderboardQuery.data?.map((entry) => (
                <div key={entry.userId} className="flex items-center justify-between rounded-2xl border border-border/70 p-3">
